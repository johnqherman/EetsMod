#pragma once
// Windows (PE32 i386) addresses for Eets.exe, as RVAs resolved against the
// runtime PE base. Recovered from the luabind registrars (see ~/eets-win-ref).
...
inline uintptr_t Object_IsRolling                   = resolve(0x5c3f0);  // (Object*) [VERIFY: dup rva]
...
inline uintptr_t Object_ForcePosition               = resolve(0x5c3f0);  // (Object*, Vector2 const&) [VERIFY: dup rva]
...
inline uintptr_t Object_KillMe                      = resolve(0xaa0b0);  // (Object*)
...
inline uintptr_t hook_Object_KillMe                 = resolve(0x0);  // -> "object_killed"  // TODO
inline uintptr_t hook_ObjectMgr_CreateObject        = resolve(0x0);  // -> "object_spawn"  // TODO
inline uintptr_t hook_World_ChangeEmotion           = resolve(0x0);  // -> "emotion_change" (ulong hash, uint emotion)  // TODO
inline uintptr_t hook_World_CheckGoal               = resolve(0x0);  // -> "goal_check" (Object*)  // TODO
...
inline uintptr_t WalkingExtension_SetWalkSpeed      = resolve(0x0);  // (Walking*, float)  // TODO
...
inline uintptr_t WalkingExtension_StartWalking      = resolve(0x0);  // (Walking*)  // TODO
inline uintptr_t WalkingExtension_StopWalking       = resolve(0x0);  // (Walking*)  // TODO
inline uintptr_t WalkingExtension_KnockDown         = resolve(0x0);  // (Walking*, Vector2 const&)  // TODO
inline uintptr_t WalkingExtension_SetNoWalkFrame    = resolve(0x0);  // (Walking*, int)  // TODO
inline uintptr_t WalkingExtension_ForceReset        = resolve(0x0);  // (Walking*)  // TODO
inline uintptr_t WalkingExtension_Reset             = resolve(0x0);  // (Walking*)  // TODO
...
inline uintptr_t SuckableExtension_WasRecentlySucked = resolve(0x0);  // (Suckable*) const -> bool  // TODO
inline uintptr_t SuckableExtension_SetSucked        = resolve(0x0);  // (Suckable*)  // TODO
inline uintptr_t PositionExtension_IsForeground     = resolve(0x0);  // (Position*) const -> bool  // TODO
inline uintptr_t PositionExtension_IsBackground     = resolve(0x0);  // (Position*) const -> bool  // TODO
inline uintptr_t PositionExtension_SetIsForeground  = resolve(0x0);  // (Position*, bool)  // TODO
...
inline uintptr_t HoldingExtension_IsHolding         = resolve(0x0);  // (Holding*, Object const*) const -> bool  // TODO
inline uintptr_t HoldingExtension_IsHoldingAny      = resolve(0x0);  // (Holding*) const -> bool  // TODO
inline uintptr_t HoldingExtension_HoldObject        = resolve(0x0);  // (Holding*, Object*)  // TODO
...
inline uintptr_t HoldingExtension_GetHolds          = resolve(0x0);  // (Holding*) const -> vector<Object*>&  // TODO
inline uintptr_t FlyingExtension_SetState           = resolve(0x0);  // (Flying*, unsigned long FS_*)  // TODO
...
inline uintptr_t EmotionPlatformExtension_GetCurrentEmotion = resolve(0x0);  // (EmoPlat*) const -> unsigned int  // TODO
