...
- **Full API list:** [`docs/NATIVE_API.md`](../docs/NATIVE_API.md) (generated by
  `make apidoc`).
...
comment). Regenerate addresses after a game update: `gen_engine_header.sh`. The
full signature list lives in [`docs/NATIVE_API.md`](../docs/NATIVE_API.md)
(`make apidoc`).
